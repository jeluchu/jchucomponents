...
fun compareVersions(first: String, second: String): Int =
    ParsedVersion.parse(first).compareTo(ParsedVersion.parse(second))
...
private data class ParsedVersion(
    ...
    override fun compareTo(other: ParsedVersion): Int {
        ...
        repeat(coreSize) { index ->
            val comparison = core.getOrElse(index) { 0L }
        ...
        repeat(prereleaseSize) { index ->
            val comparison = compareIdentifiers(
    ...
    companion object {
        fun parse(value: String): ParsedVersion {
            ...
            val core = coreValue.split(".").map { component ->
            ...
            val prerelease = prereleaseValue.takeIf(String::isNotEmpty)?.split(".")?.also {
                require(it.all { identifier ->
