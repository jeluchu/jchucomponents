...
object CatalogFixtures {
    ...
    val floatingButtonFixtures = listOf(
    ...
    val youtubeChipFixtures = listOf(
        CatalogChipFixture(
            name = "Selected",
            kind = CatalogFixtureKind.ENABLED,
            label = "Selected",
