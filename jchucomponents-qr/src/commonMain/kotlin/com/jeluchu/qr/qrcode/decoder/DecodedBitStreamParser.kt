...
import com.jeluchu.qr.common.BitSource
import com.jeluchu.qr.common.CharacterSetECI
import com.jeluchu.qr.common.DecoderResult
import com.jeluchu.qr.common.StringUtils
import com.jeluchu.qr.common.StringUtils.guessEncoding
import com.jeluchu.qr.common.qrDecodeBytes
import com.jeluchu.qr.qrcode.decoder.Mode.Companion.forBits
...
internal object DecodedBitStreamParser {
    ...
    private fun decodeHanziSegment(
        ...
        runCatching {
            result.append(qrDecodeBytes(buffer, StringUtils.GB2312))
        }.getOrElse { throw formatInstance }
    }
