...
package com.jeluchu.jchucomponentscompose.core.extensions.intent

const val INTENT_TYPE_EMAIL = "message/rfc822"
const val INTENT_TYPE_TEXT = "text/plain"
const val INTENT_TYPE_JSON = "application/json"
...
const val INTENT_TYPE_DOCUMENT = "*/*"